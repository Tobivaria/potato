...
void main() {
  ...
  test('Copy language data', () {
    ...
    final LanguageData data = LanguageData();
    final LanguageData copy = data.copyWith(languages: languages, arbDefinitions: arbDefinitions);
  ...
  test('Export base language', () {
    ...
    final LanguageData data = LanguageData(existingLanguages: languages, existingArdbDefinitions: arbDefinitions);
    ...
    expect(data.exportLanguage('en', ['bye', 'greeting'], isBaseLanguage: true), expected);
  });
}
